...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container position-relative d-flex align-items-center justify-content-between">
            ...
            <a class="btn-getstarted" href="index.html#order-online">Đặt hàng</a>
    ...
    <main class="main">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-5" data-aos="fade-up" data-aos-delay="250">
                        <div class="content ps-0 ps-lg-5">
                            <p class="fst-italic">
                                Tại GoBread, chúng tôi cam kết mang đến những chiếc bánh mì tươi ngon, chất lượng nhất
                                cho khách hàng.
                                Nguyên liệu được chọn lọc kỹ càng, bánh mì luôn nóng giòn và nhân đầy đủ dinh dưỡng.
                            </p>
                            <ul>
                                <li><i class="bi bi-check-circle-fill"></i> <span>Bánh mì giòn rụm, nhân đậm đà, phù hợp
                                        khẩu vị mọi người..</span></li>
                                <li><i class="bi bi-check-circle-fill"></i> <span>Nguyên liệu tươi sạch, chế biến ngay
                                        trong ngày.</span></li>
                                <li><i class="bi bi-check-circle-fill"></i> <span>Đa dạng hương vị từ truyền thống đến
                                        sáng tạo, phù hợp với mọi sở thích.</span></li>
                            </ul>
                            <p>
                                Chúng tôi không ngừng cải tiến để mang đến trải nghiệm ẩm thực tuyệt vời nhất.
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="why-box">
                            ...
                            <p>
                                GoBread mang đến trải nghiệm ẩm thực tuyệt vời với bánh mì tươi ngon, nóng giòn mỗi
                                ngày.
                                Công thức độc quyền giúp hương vị đậm đà, hấp dẫn. Nguyên liệu sạch, dinh dưỡng cân
                                bằng, đảm bảo an toàn cho sức khỏe.
                                Đặc biệt, dịch vụ nhanh chóng, tiện lợi, giúp bạn có bữa ăn ngon mà không tốn thời gian.
                        ...
                        <div class="row gy-4" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="col-xl-4">
                                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <p>Sử dụng nguyên liệu chất lượng cao, đảm bảo vệ sinh và an toàn thực phẩm.</p>
                                </div>
                            </div><!-- End Icon Box -->
                            ...
                            <div class="col-xl-4" data-aos="fade-up" data-aos-delay="300">
                                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <p>Công thức chế biến đặc biệt, kết hợp gia vị tinh tế, tạo nên hương vị khó quên.
                                    </p>
                                </div>
                            </div><!-- End Icon Box -->
                            ...
                            <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <p>Phục vụ nhanh, tiện lợi, giúp bạn tiết kiệm thời gian mà vẫn có bữa ăn ngon.</p>
                                </div>
                            </div><!-- End Icon Box -->
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-2.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-2.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-3.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-3.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-4.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-4.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-5.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-5.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-6.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-6.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-7.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-7.jpg" class="menu-img img-fluid" alt=""></a>
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-8.png" class="glightbox"><img
                                        src="assets/img/menu/menu-item-8.png" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-9.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-9.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-10.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-10.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-11.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-11.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-12.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-12.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-13.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-13.jpg" class="menu-img img-fluid" alt=""></a>
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-14.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-14.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-15.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-15.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-16.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-16.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-17.png" class="glightbox"><img
                                        src="assets/img/menu/menu-item-17.png" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-18.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-18.jpg" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-19.jpg" class="glightbox"><img
                                        src="assets/img/menu/menu-item-19.jpg" class="menu-img img-fluid" alt=""></a>
                        ...
                        <div class="row gy-5">
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-20.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-20.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-21.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-21.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-22.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-22.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-23.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-23.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-24.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-24.webp" class="menu-img img-fluid" alt=""></a>
                            ...
                            <div class="col-lg-4 menu-item">
                                <a href="assets/img/menu/menu-item-25.webp" class="glightbox"><img
                                        src="assets/img/menu/menu-item-25.webp" class="menu-img img-fluid" alt=""></a>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="testimonial-content">
                                            <p>
                                                ...
                                                <span>"Bánh mì ở GoBread thật sự đỉnh! Vỏ giòn, nhân đầy đặn, đặc biệt
                                                    là sốt siêu ngon.
                                ...
                                <div class="row gy-4 justify-content-center">
                                    <div class="col-lg-6">
                                        <div class="testimonial-content">
                                            <p>
                                                <i class="bi bi-quote quote-icon-left"></i>
                                                <span>"GoBread đúng chuẩn bánh mì cho dân công sở! Nhanh, gọn, ngon mà
                                                    vẫn đầy đủ dinh dưỡng.
                                                    Bánh mì gà BBQ sốt mật ong là chân ái của mình, vừa thơm vừa đậm
                                                    vị."</span>
                                                <i class="bi bi-quote quote-icon-right"></i>
                                            </p>
                                            <h3>Hùng</h3>
                                ...
                                <div class="row gy-4 justify-content-center">
                                    <div class="col-lg-6">
                                        <div class="testimonial-content">
                                            <p>
                                                <i class="bi bi-quote quote-icon-left"></i>
                                                <span>"Bánh mì xịn xò nhất từng ăn! Không chỉ ngon mà còn đẹp mắt nữa,
                                                    chụp hình sống ảo siêu chất.
                                                    Combo Bánh Mì Chảo Phô Mai + Trà Đào Cam Sả là best!"</span>
                                                <i class="bi bi-quote quote-icon-right"></i>
                                            </p>
                                            <h3>Minh</h3>
                                            <h4>GenZ, 18 tuổi</h4>
                                ...
                                <div class="row gy-4 justify-content-center">
                                    <div class="col-lg-6">
                                        <div class="testimonial-content">
                                            <p>
                                                <i class="bi bi-quote quote-icon-left"></i>
                                                <span>"Bánh mì ở đây ngon và chất lượng, vị đậm đà, nguyên liệu tươi
                                                    ngon. Mình và gia đình đều thíchnhất bánh mì heo quay giòn rụm, lớp
                  ...
                  "spaceBetween": 1
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            ...
                            <p class="description">
                                "Mua một ổ bánh mì bất kỳ, nhận ngay một ổ miễn phí! Thưởng thức vị ngon nhân đôi!"
                            </p>
                        </div><!-- End Event item -->
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            ...
                            <p class="description">
                                "Đặt hàng lần đầu tiên? Giảm ngay 20%! Trải nghiệm bánh mì chất lượng với giá siêu hời!"
                            </p>
                        </div><!-- End Event item -->
                        ...
                        <div class="swiper-slide event-item d-flex flex-column justify-content-end"
                            ...
                            <p class="description">
                                "Đặt đơn từ 100K, freeship tận nơi! Ngồi nhà thưởng thức, không lo phí ship!"
                            </p>
                        </div><!-- End Event item -->
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member">
                            ...
                            <div class="member-info">
                                ...
                                <span>Phục Vụ</span>
                                <p>Nhanh tay, khả năng nắm bắt tâm lí khách hàng. Đảm bảo món ăn được đến tay khách hàng
                                    nhanh nhất có thể.</p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-member">
                            ...
                            <div class="member-info">
                                ...
                                <p>Đây là đầu bếp 5 sao của chúng tôi với 10 năm kinh nghiệm làm bánh mì. Đảm bảo hương
                    ...
                    <div class="col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member">
                            ...
                            <div class="member-info">
                                ...
                                <p>Nhân viên kỳ cựu với kinh nghiệm vệ sinh lâu năm. Đảm bảo nhà hàng chúng tôi luôn
            ...
            <div class="container">
                <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 order-img"
                        style="background-image: url(assets/img/order-online.jpg); border-radius: 15px;"></div>
        ...
        <section id="contact" class="contact section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Liên Hệ</h2>
                <p><span>Bạn Cần Giúp Đỡ</span> <span class="description-title">Hãy Liên Lạc Chúng Tôi</span></p>
            </div><!-- End Section Title -->
    ...
    <footer id="footer" class="footer dark-background">
        ...
        <div class="container copyright text-center mt-4">
            <p>© <span>Copyright</span> <strong class="px-1 sitename">GoBread</strong> <span>All Rights Reserved</span>
            </p>
            <div class="credits">
